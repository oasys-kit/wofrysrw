...
e, h, v, i = undulator.get_flux_per_unit_surface(undulator.get_SRW_Wavefront(wf_parameters))
...
e, i = undulator.get_spectral_flux(undulator.get_SRW_Wavefront(wf_parameters), multi_electron=True)
